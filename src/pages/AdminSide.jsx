    ...
    <div>
      ...
      {fane === "varer" && (
        <div>
          ...
          {vareFane === "varetyper" && <VaretypeAdmin varetyper={varetyper} varekategorier={varekategorier} onAdd={onAddVaretype} onUpdate={onUpdateVaretype} onDelete={onDeleteVaretype} />}
          {vareFane === "primaer" && <PrimaerydelseAdmin primaerydelser={primaerydelser} onAdd={onAddPrimaerydelse} onUpdate={onUpdatePrimaerydelse} onDelete={onDeletePrimaerydelse} />}
          {vareFane === "tillaeg" && <TillaegsydelseAdmin tillaegsydelser={tillaegsydelser} varetyper={varetyper} primaerydelser={primaerydelser} onAdd={onAddTillaegsydelse} onUpdate={onUpdateTillaegsydelse} onDelete={onDeleteTillaegsydelse} />}
        </div>
      )}
    </div>
  );
